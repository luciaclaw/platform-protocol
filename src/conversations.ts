...
export type ConversationsListMessage =
  MessageEnvelope<ConversationsListPayload> & {
...
export type ConversationsLoadMessage =
  MessageEnvelope<ConversationsLoadPayload> & {
...
export type ConversationsResponseMessage =
  MessageEnvelope<ConversationsResponsePayload> & {
...
export type ConversationsDeleteMessage =
  MessageEnvelope<ConversationsDeletePayload> & {
