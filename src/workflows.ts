...
export type WorkflowCreateMessage = MessageEnvelope<WorkflowCreatePayload> & { type: 'workflow.create' };
...
export type WorkflowUpdateMessage = MessageEnvelope<WorkflowUpdatePayload> & { type: 'workflow.update' };

export interface WorkflowDeletePayload {
  workflowId: string;
}
export type WorkflowDeleteMessage = MessageEnvelope<WorkflowDeletePayload> & { type: 'workflow.delete' };

export interface WorkflowListPayload {
  status?: WorkflowStatus;
}
export type WorkflowListMessage = MessageEnvelope<WorkflowListPayload> & { type: 'workflow.list' };
...
export type WorkflowExecuteMessage = MessageEnvelope<WorkflowExecutePayload> & { type: 'workflow.execute' };

export interface WorkflowResponsePayload {
  workflows?: WorkflowInfo[];
  execution?: WorkflowExecutionInfo;
}
export type WorkflowResponseMessage = MessageEnvelope<WorkflowResponsePayload> & { type: 'workflow.response' };

export interface WorkflowStatusPayload {
  execution: WorkflowExecutionInfo;
}
export type WorkflowStatusMessage = MessageEnvelope<WorkflowStatusPayload> & { type: 'workflow.status' };
