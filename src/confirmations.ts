...
export type ToolConfirmRequestMessage =
  MessageEnvelope<ToolConfirmRequestPayload> & {
...
export type ToolConfirmResponseMessage =
  MessageEnvelope<ToolConfirmResponsePayload> & {
