...
export type IntegrationsListMessage =
  MessageEnvelope<IntegrationsListPayload> & {
...
export type IntegrationsResponseMessage =
  MessageEnvelope<IntegrationsResponsePayload> & {
