...
export type HandshakeResponseMessage = MessageEnvelope<HandshakeResponsePayload> & {
...
export type HandshakeCompleteMessage = MessageEnvelope<HandshakeCompletePayload> & {
