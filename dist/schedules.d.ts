...
export type ScheduleCreateMessage = MessageEnvelope<ScheduleCreatePayload> & {
...
export type ScheduleUpdateMessage = MessageEnvelope<ScheduleUpdatePayload> & {
...
export type ScheduleDeleteMessage = MessageEnvelope<ScheduleDeletePayload> & {
...
export type ScheduleListMessage = MessageEnvelope<ScheduleListPayload> & {
    type: 'schedule.list';
};
...
export type ScheduleResponseMessage = MessageEnvelope<ScheduleResponsePayload> & {
...
export type ScheduleExecutedMessage = MessageEnvelope<ScheduleExecutedPayload> & {
